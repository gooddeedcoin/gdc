    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gdc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gdc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gdc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gdc Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gdc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gdc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gdc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gdc addresses"));
    ...
    openAction->setStatusTip(tr("Open a gdc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gdc Core help message to get a list with possible Gdc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gdc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gdc network", "", count));
}
...
{
    QString strTitle = tr("Gdc Core"); // default title
