    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gdc Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Gdc Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gdc-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gdc Core is shutting down...") + "<br /><br />" +
