...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Gdc features */
    { "gdc",               "masternode",             &masternode,             true,      true,       false },
    { "gdc",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "gdc",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "gdc",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "gdc",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "gdc",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "gdc",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "gdc",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use gdcd, or the -server option to gdc-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> gdc-cli " + methodname + " " + args + "\n";
}
